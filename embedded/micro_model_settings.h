...
// The following values are updated to match your 32x32 QAT model
constexpr int kMaxAudioSampleSize = 512;
constexpr int kAudioSampleFrequency = 16000;

// Your model uses a 32x32 spectrogram
constexpr int kFeatureSize = 32;          // Height (Frequency bins)
constexpr int kFeatureCount = 32;         // Width (Time slices)
constexpr int kFeatureElementCount = (kFeatureSize * kFeatureCount); // 1024

// These timings usually match the standard 16kHz preprocessing
constexpr int kFeatureStrideMs = 20;
constexpr int kFeatureDurationMs = 30;

// Updated for your 3 specific classes: Activate, No, Silence
